export const PLAY_MONEY_ADDRESS = process.env.NEXT_PUBLIC_PLAY_MONEY_ADDRESS || "0x0000000000000000000000000000000000000000";
export const STOCK_AMM_ADDRESS = process.env.NEXT_PUBLIC_STOCK_AMM_ADDRESS || "0x0000000000000000000000000000000000000000";
